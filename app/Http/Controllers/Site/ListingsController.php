            ...
            $query = User::leftJoin('services_detail_infos', 'users.id', '=', 'services_detail_infos.user_id')
                ...
                if($service_city != ''){
                    ...
                    if(is_array($results)){
                        ...
                        //print_r(implode(',', $loc));exit;
                        //$query->whereIn('vendor_inforamations.city', $loc);
                        /*$query->where('vendor_inforamations.city', 'like', '%' . trim(implode(',', $loc)) . '%');
                        $query->orWhere('vendor_inforamations.state', 'like', '%' . trim(implode(',', $loc)). '%');*/
                    }else{
